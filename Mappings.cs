...
namespace UttrekkFamilia
{
    internal class Mappings
    {
        ...
        private readonly NameValueCollection SSBUnderkategori = new() {
            ...
            { "113", "WEBSTER-STRATTON_-_DE_UTROLIGE_ÅRENE" },
        ...
        private readonly NameValueCollection HjemlerOversettelseNyTilGammelLov = new() {
            ...
            {"§ 2-5","Bvl._§_4-3_(gammel_lov)" },
            {"§ 2-5,1.","Bvl._§_4-3_(gammel_lov)" },
            {"§ 2-5,1.c","Bvl._§_4-3_(gammel_lov)" },
            ...
            {"§ 7-1","Bvl._§_4-19_(gammel_lov)" },
            {"§ 7-2","Bvl._§_4-19_(gammel_lov)" },
            {"§ 7-2,1.","Bvl._§_4-19_(gammel_lov)" },
        ...
        private readonly NameValueCollection ÅrsakFlyttingFrakoder = new() {
            ...
            { "2.1","2.1_AVSLUTTET_I_HENHOLD_TIL_PLAN_VED_OPPSTART_AV_INSTITUSJONSOPPHOLDET" },
            { "1.2.1","1.2.1_BARNET_HAR_BEHOV_FOSTERFORELDRE_IKKE_KAN_DEKKE" },
            { "2.2","1.2.2_ENDRING_I_FOSTERFORELDRES_LIVSSITUASJON_(SKILSMISSE_DØD_OSV.)" },
            { "2.3","2.3_BARNET_HAR_BEHOV_FOR_ANNEN_TYPE_PLASSERINGSTILTAK_(ANNEN_TYPE_INSTITUSJON_TFCO_FOSTERHJEM_FORSTERKET_FOSTERHJEM_OSV.)" }
       };
